...
final popularViewModelProvider = NotifierProvider<PopularViewModel, List<Movie>>(() {
  return PopularViewModel();
});

final topRatedViewModelProvider = NotifierProvider<TopRatedViewModel, List<Movie>>(() {
